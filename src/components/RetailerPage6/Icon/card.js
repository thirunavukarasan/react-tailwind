    ...
    return (
      <>
        ...
        <div className=" md:weaverz-ai-container md:weaverz-ai-mx-auto">
          ...
          <div className="weaverz-ai-grid weaverz-ai-gap-x-10 xlg:weaverz-ai-grid-rows-2 xlg:weaverz-ai-grid-cols-4 md:weaverz-ai-grid-cols-4 sm:weaverz-ai-grid-cols-2 xsm:weaverz-ai-grid-cols-2 ">
            ...
            <Content
             ...
             <div className="">
              <Content
                ...
                content="Run confidently knowing we logged thousands of miles"
            ...
            <div ClassName="">
              <Content
                ...
                content="Our signature eyelets are embroidered directly"
             ...
             <Content
                ...
                content="Our removable castor bean sockliner emits less carbon"
